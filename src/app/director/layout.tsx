...
const directorNavigation = [
  { name: 'Overview', href: '/director/dashboard', icon: LayoutDashboard },
  { name: 'Hostels', href: '/director/hostels', icon: Building2 },
  { name: 'Reports', href: '/director/reports', icon: BarChart3 },
]
